...
Note: The stock screen will not boot if the UART is connected. To test the boot process on the stock screen, disconnect the UART from the printer before powering on ther printer.
